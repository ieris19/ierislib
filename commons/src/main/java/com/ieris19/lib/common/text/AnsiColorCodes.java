...
public enum AnsiColorCodes {
    ...
    /**
     * A {@link AnsiColorCodes AnsiColorCodes} turned string corresponds to the ANSI code. Thus, the method
     ...
     */
    public static String format(String string, AnsiColorCodes color) {
