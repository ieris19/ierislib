...
public class IerisFX extends Application {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(IerisFX.class);
    /**
    ...
    /**
     * ViewManager instance to manage the views in the application
     */
     ...
     */
    static void setInit(Script initScript) {
     ...
     */
    static void setStart(Script startScript) {
     ...
     */
    static void setStop(Script stopScript) {
    ...
    public void init() throws Exception {
        ...
        initScript.execute();
        this.viewManager = new ViewManager(IerisFX.settings);
    }
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        startScript.execute();
        this.viewManager.start(primaryStage);
    }
