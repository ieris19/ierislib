...
import com.ieris19.lib.ui.core.FXManager;
import javafx.beans.property.Property;
import javafx.scene.layout.Region;

/**
 * This class represents the view controller of a Component. This class is responsible for linking the user and
...
public abstract class ViewController {
	...
	/**
	 * The {@link Component} that this view is part of. This is used to access the {@link ViewModel} and save a
	 ...
	 * instead, the {@link #init(FXManager, Component, Region) init()} method should be used to initialize the view.
	 */
	 ...
	 * the initialization of the view until the view is actually used. This method is called by the {@link FXManager}
	 * when the view is first used.
	 *
	 * <p>
	 * Importantly, this method will take a generic {@link Component} as a parameter, but it is expected that the
	 ...
	 * </p>
	 *
	 * @param FXManager the view manager for the application that this view is part of.
	 * @param view        the {@link Component} that this view is part of.
	 * @param root        the root node of the view.
	 */
	public void init(FXManager FXManager, Component view, Region root) {
		this.root = root;
