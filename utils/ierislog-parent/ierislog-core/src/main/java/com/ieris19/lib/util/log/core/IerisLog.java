...
public class IerisLog implements IerisLogger {
     ...
     */
    @Override
    public void changeLogDirectory(File newDirectory) throws IllegalArgumentException {
     ...
     */
    @Override
    public void useANSI(boolean isEnabled) {
        synchronizedLock.lock();
     ...
     */
    @Override
    public boolean isLevel(Level severity) {
        synchronizedLock.lock();
        try {
     ...
     */
    @Override
    public void log(String message, Level level, TextColor color) {
        synchronizedLock.lock();
        if (isLevel(level)) {
