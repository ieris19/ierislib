...
import static com.ieris19.lib.util.log.TimestampHandler.ChronoFormat.EUROPEAN;
import static com.ieris19.lib.util.log.TimestampHandler.ChronoFormat.ISO;
...
class TimestampHandlerTest {
	...
	class FormatterTest {
		...
		@Test @DisplayName ("ISO Proper Format") void isoFormat() {
			LocalDateTime time = LocalDateTime.of(2022, 2, 5, 21, 21, 21);
			assertEquals(time.format(ISO.get()), "2022-02-05T21:21:21");
		}
	}
